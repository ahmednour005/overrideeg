...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["landing-landing-module"], {
  ...
  function srcAppLandingLandingComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LandingComponent = /*#__PURE__*/function () {
      function LandingComponent(serv) {
      ...
      _createClass(LandingComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.subscribe = this.serv.getValues().subscribe(function (res) {
            _this.posts = res;
          });
          this.subscribe = this.serv.getCommentsValues().subscribe(function (ress) {
            _this.comments = ress;
          });
        }
      }, {
    ...
    LandingComponent.ɵfac = function LandingComponent_Factory(t) {
      return new (t || LandingComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_service_service__WEBPACK_IMPORTED_MODULE_1__["ServiceService"]));
    };
    ...
    LandingComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 3,
      vars: 1,
      consts: [[1, "container", "postsComponent"], [1, "row"], ["class", "col-md-12", 4, "ngFor", "ngForOf"], [1, "col-md-12"], [1, "item"], [1, "card"], [1, "header"], ["src", "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Circle-icons-profile.svg/1200px-Circle-icons-profile.svg.png"], [1, "user"], [1, "username"], [1, "card-body"], [1, "card-title"], [1, "card-text"], [1, "footer", "text-center"], [1, "col-4"], [1, "icon"], [1, "fa", "fa-heart"], [1, "fa", "fa-retweet"], [1, "fa", "fa-comment"]],
