...
const routes = [
    { path: 'panel',
        loadChildren: () => __webpack_require__.e(/*! import() | panel-panel-module */ "panel-panel-module").then(__webpack_require__.bind(null, /*! ./panel/panel.module */ "./src/app/panel/panel.module.ts")).then(p => p.PanelModule) },
    { path: 'landing',
